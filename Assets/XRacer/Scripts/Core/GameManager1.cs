...
//		OnEnterStateGame ();
		...
		//Admob.Instance ().showBannerRelative (AdSize.MediumRectangle, AdPosition.MIDDLE_RIGHT, 0, "Falcon");
	...
	public void showControls()
	{
		...
		//Admob.Instance ().removeBanner ("Falcon");
	}
...
//	}
	...
	public void OnStartGamePressed()
	{
		SoundManager.PlaySfx("ButtonPress");
		menuSystem.ExitAll();
		ScreenFaderFadeIn(0.1f, ()=>OnEnterStateGame());
	}
...
//		if (adbool) {
//
//			Admob.Instance ().showBannerRelative (AdSize.MediumRectangle, AdPosition.MIDDLE_RIGHT,0,"fail1" );
//
