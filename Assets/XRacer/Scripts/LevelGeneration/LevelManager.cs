...
public class LevelManager : MonoBehaviour 
{
	...
	public LevelSection[] levelSections;		// the list of all the level sections in the world
	public int currentSection = 0;				// the current section we are generating rows from
